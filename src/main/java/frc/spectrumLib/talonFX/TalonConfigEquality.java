...
public class TalonConfigEquality {
    ...
    public static boolean isEqual(MotorOutputConfigs a, MotorOutputConfigs b) {
        boolean val =
                a.Inverted.value == b.Inverted.value
                        ...
                        && Util.epsilonEquals(
                                a.DutyCycleNeutralDeadband,
                                b.DutyCycleNeutralDeadband,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.PeakForwardDutyCycle,
                                b.PeakForwardDutyCycle,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.PeakReverseDutyCycle,
                                b.PeakReverseDutyCycle,
                                TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(CurrentLimitsConfigs a, CurrentLimitsConfigs b) {
        boolean val =
                Util.epsilonEquals(a.StatorCurrentLimit, b.StatorCurrentLimit, TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.SupplyCurrentLimit, b.SupplyCurrentLimit, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(VoltageConfigs a, VoltageConfigs b) {
        boolean val =
                Util.epsilonEquals(
                                a.SupplyVoltageTimeConstant,
                                b.SupplyVoltageTimeConstant,
                                TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(TorqueCurrentConfigs a, TorqueCurrentConfigs b) {
        boolean val =
                Util.epsilonEquals(
                                a.PeakForwardTorqueCurrent,
                                b.PeakForwardTorqueCurrent,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.PeakReverseTorqueCurrent,
                                b.PeakReverseTorqueCurrent,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.TorqueNeutralDeadband,
                                b.TorqueNeutralDeadband,
                                TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(FeedbackConfigs a, FeedbackConfigs b) {
        boolean val =
                Util.epsilonEquals(
                                a.FeedbackRotorOffset, b.FeedbackRotorOffset, TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.SensorToMechanismRatio,
                                b.SensorToMechanismRatio,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.RotorToSensorRatio, b.RotorToSensorRatio, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(OpenLoopRampsConfigs a, OpenLoopRampsConfigs b) {
        boolean val =
                Util.epsilonEquals(
                                ...
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.VoltageOpenLoopRampPeriod,
                                b.VoltageOpenLoopRampPeriod,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.TorqueOpenLoopRampPeriod,
                                b.TorqueOpenLoopRampPeriod,
                                TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
        ...
        boolean val =
                Util.epsilonEquals(
                        ...
                        && Util.epsilonEquals(
                                ...
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.TorqueClosedLoopRampPeriod,
                                b.TorqueClosedLoopRampPeriod,
                                TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(SoftwareLimitSwitchConfigs a, SoftwareLimitSwitchConfigs b) {
        boolean val =
                Util.epsilonEquals(
                                a.ForwardSoftLimitThreshold,
                                b.ForwardSoftLimitThreshold,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.ReverseSoftLimitThreshold,
                                b.ReverseSoftLimitThreshold,
                                TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(MotionMagicConfigs a, MotionMagicConfigs b) {
        boolean val =
                Util.epsilonEquals(
                                a.MotionMagicAcceleration,
                                b.MotionMagicAcceleration,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.MotionMagicCruiseVelocity,
                                b.MotionMagicCruiseVelocity,
                                TALON_CONFIG_EPSILON)
                        && Util.epsilonEquals(
                                a.MotionMagicJerk, b.MotionMagicJerk, TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
