...
import frc.robot.utils.CompetitionFieldUtils.SpectrumTimeUtils;

import static frc.robot.utils.CompetitionFieldUtils.constants.FieldConstants.*;
...
public class Crescendo2024FieldSimulation extends CompetitionFieldSimulation {
    ...
    private void simulateHumanPlayer() {
        ...
        if (SpectrumTimeUtils.getLogTimeSeconds() - previousThrowTimeSeconds < 1) return;
        ...
        previousThrowTimeSeconds = SpectrumTimeUtils.getLogTimeSeconds();
    }
}
