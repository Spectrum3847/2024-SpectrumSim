...
public class Intake extends SubsystemBase {
    private static final TalonFX armMotor = new TalonFX(RobotConfig.Intake.Arm.deviceID);
    ...
    private static final TalonFX rollerMotor = new TalonFX(RobotConfig.Intake.Roller.deviceID);
    ...
    public Intake() {
        ...
        armConfig.Feedback.SensorToMechanismRatio = RobotConfig.Intake.Arm.ratio * 2.0 * Math.PI;
        ...
        armMotor.setPosition(RobotConfig.Intake.Arm.startingAngle);
        retract();
        intakeSim = new IntakeSim();
    }

    public void deploy() {
        setPosition(RobotConfig.Intake.Arm.deployAngle);
        rollerMotor.set(1.0);
    }

    public void retract() {
        setPosition(RobotConfig.Intake.Arm.stowAngle);
        rollerMotor.set(0.0);
    }
